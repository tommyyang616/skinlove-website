...
export default function Gallery() {
  ...
  const onLbTouchEnd = useCallback(() => {
    ...
    if (Math.abs(dragRef.current) > 50) navLB(dragRef.current < 0 ? 1 : -1);
    dragRef.current = 0;
  }, [navLB]);
        ...
        <div className="container">
          ...
          <div className="gallery-note reveal">
            ...
            <a href="https://www.instagram.com/skinlove_tattoopiercing/" target="_blank" rel="noopener noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: 6 }}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--pink-text)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5" /><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" /><line x1="17.5" y1="6.5" x2="17.51" y2="6.5" /></svg>
              Instagram
            </a>
          </div>
        </div>
