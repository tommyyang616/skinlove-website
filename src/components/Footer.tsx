    ...
    <footer>
      <div className="container">
        ...
        <div style={{ display: "flex", justifyContent: "center", gap: 20, marginBottom: 20 }}>
          <a href="https://www.instagram.com/skinlove_tattoopiercing/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" style={{ color: "#bb3599", transition: "opacity 0.2s" }}>
          ...
          <a href="https://www.facebook.com/skinlovetattoopiercing" target="_blank" rel="noopener noreferrer" aria-label="Facebook" style={{ color: "#bb3599", transition: "opacity 0.2s" }}>
          ...
          <a href="https://www.tiktok.com/@skinlove_tattoopiercing" target="_blank" rel="noopener noreferrer" aria-label="TikTok" style={{ color: "#bb3599", transition: "opacity 0.2s" }}>
